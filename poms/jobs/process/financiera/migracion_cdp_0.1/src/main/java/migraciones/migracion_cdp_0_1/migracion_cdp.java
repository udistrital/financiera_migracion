...
package migraciones.migracion_cdp_0_1;
...
/**
 * Job: migracion_cdp Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class migracion_cdp implements TalendJob {
...
public Integer getVigencia(){
	...
	private final String jobName = "migracion_cdp";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				migracion_cdp.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(migracion_cdp.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_1.put("disponibilidad", context.disponibilidad);
			paraList_tRunJob_1.add("--context_type " + "disponibilidad" + "=" + "id_Integer");
		
			parentContextMap_tRunJob_1.put("vigencia", context.vigencia);
			paraList_tRunJob_1.add("--context_type " + "vigencia" + "=" + "id_Integer");
	...
	Object obj_tRunJob_1 = null;
		...
		migraciones.volcado_cdp_0_1.volcado_cdp childJob_tRunJob_1 = new migraciones.volcado_cdp_0_1.volcado_cdp();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_2 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_2.put("disponibilidad", context.disponibilidad);
			paraList_tRunJob_2.add("--context_type " + "disponibilidad" + "=" + "id_Integer");
		
			parentContextMap_tRunJob_2.put("vigencia", context.vigencia);
			paraList_tRunJob_2.add("--context_type " + "vigencia" + "=" + "id_Integer");
	...
	Object obj_tRunJob_2 = null;
		...
		migraciones.ajuste_cdp_solicitud_0_1.ajuste_cdp_solicitud childJob_tRunJob_2 = new migraciones.ajuste_cdp_solicitud_0_1.ajuste_cdp_solicitud();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final migracion_cdp migracion_cdpClass = new migracion_cdp();

        int exitCode = migracion_cdpClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = migracion_cdp.class.getClassLoader().getResourceAsStream("migraciones/migracion_cdp_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = migracion_cdp.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : migracion_cdp");
        }
...
/************************************************************************************************
 *     36270 characters generated by Talend Open Studio for Data Integration 
