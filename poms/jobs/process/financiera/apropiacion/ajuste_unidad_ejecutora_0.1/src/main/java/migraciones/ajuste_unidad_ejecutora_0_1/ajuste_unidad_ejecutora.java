...
package migraciones.ajuste_unidad_ejecutora_0_1;
...
/**
 * Job: ajuste_unidad_ejecutora Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class ajuste_unidad_ejecutora implements TalendJob {
	...
	private final String jobName = "ajuste_unidad_ejecutora";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ajuste_unidad_ejecutora.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ajuste_unidad_ejecutora.this,
	...
	public void tPostgresqlRow_8_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tPostgresqlRow_8_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tPostgresqlRow_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tPostgresqlRow_2 = "DROP AGGREGATE IF EXISTS mul(bigint);\nCREATE AGGREGATE mul(bigint) ( SFUNC = int8mul, STYPE=bigint );";
	...
	public void tPostgresqlRow_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tPostgresqlRow_1 = "UPDATE financiera.rubro\nSET unidad_ejecutora=subquery.ue\nFROM (\nSELECT r.id, tabla1.ue\nFROM (SELECT padre, POWER(mul(ta"
						+ "bla_1.unidad_ejecutora), 1.0/COUNT(*)) as ue FROM\n(SELECT financiera.rubro.*, (regexp_matches (codigo,\n  '^(([0-9]*){1}("
						+ "-[0-9]*){6})'))[1] AS padre \n FROM financiera.rubro WHERE codigo ~ '^([0-9]*){1}(-[0-9]*){7}$' ORDER BY codigo) tabla_1 "
						+ "GROUP BY \n padre ORDER BY padre) tabla1, financiera.rubro r\nWHERE r.codigo = tabla1.padre\n) subquery\nWHERE financiera.ru"
						+ "bro.id = subquery.id;";
	...
	public void tPostgresqlRow_3Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tPostgresqlRow_3 = "UPDATE financiera.rubro\nSET unidad_ejecutora=subquery.ue\nFROM (\nSELECT r.id, tabla1.ue\nFROM (SELECT padre, POWER(mul(ta"
						+ "bla_1.unidad_ejecutora), 1.0/COUNT(*)) as ue FROM\n(SELECT financiera.rubro.*, (regexp_matches (codigo, '^(([0-9]*){1}(-["
						+ "0-9]*){5})'))[1] AS padre FROM financiera.rubro WHERE codigo ~ '^([0-9]*){1}(-[0-9]*){6}$' ORDER BY codigo) tabla_1 GROU"
						+ "P BY padre ORDER BY padre) tabla1, financiera.rubro r\nWHERE r.codigo = tabla1.padre\n) subquery\nWHERE financiera.rubro.id"
						+ " = subquery.id;";
	...
	public void tPostgresqlRow_4Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tPostgresqlRow_4 = "UPDATE financiera.rubro\nSET unidad_ejecutora=subquery.ue\nFROM (\nSELECT r.id, tabla1.ue\nFROM (SELECT padre, POWER(mul(ta"
						+ "bla_1.unidad_ejecutora), 1.0/COUNT(*)) as ue FROM\n(SELECT financiera.rubro.*, (regexp_matches (codigo, '^(([0-9]*){1}(-["
						+ "0-9]*){4})'))[1] AS padre FROM financiera.rubro WHERE codigo ~ '^([0-9]*){1}(-[0-9]*){5}$' ORDER BY codigo) tabla_1 GROU"
						+ "P BY padre ORDER BY padre) tabla1, financiera.rubro r\nWHERE r.codigo = tabla1.padre\n) subquery\nWHERE financiera.rubro.id"
						+ " = subquery.id;";
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tPostgresqlRow_4:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tPostgresqlRow_5Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tPostgresqlRow_5 = "UPDATE financiera.rubro\nSET unidad_ejecutora=subquery.ue\nFROM (\nSELECT r.id, tabla1.ue\nFROM (SELECT padre, POWER(mul(ta"
						+ "bla_1.unidad_ejecutora), 1.0/COUNT(*)) as ue FROM\n(SELECT financiera.rubro.*, (regexp_matches (codigo, '^(([0-9]*){1}(-["
						+ "0-9]*){3})'))[1] AS padre FROM financiera.rubro WHERE codigo ~ '^([0-9]*){1}(-[0-9]*){4}$' ORDER BY codigo) tabla_1 GROU"
						+ "P BY padre ORDER BY padre) tabla1, financiera.rubro r\nWHERE r.codigo = tabla1.padre\n) subquery\nWHERE financiera.rubro.id"
						+ " = subquery.id;";
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tPostgresqlRow_5:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tPostgresqlRow_6Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tPostgresqlRow_6 = "UPDATE financiera.rubro\nSET unidad_ejecutora=subquery.ue\nFROM (\nSELECT r.id, tabla1.ue\nFROM (SELECT padre, POWER(mul(ta"
						+ "bla_1.unidad_ejecutora), 1.0/COUNT(*)) as ue FROM\n(SELECT financiera.rubro.*, (regexp_matches (codigo, '^(([0-9]*){1}(-["
						+ "0-9]*){2})'))[1] AS padre FROM financiera.rubro WHERE codigo ~ '^([0-9]*){1}(-[0-9]*){3}$' ORDER BY codigo) tabla_1 GROU"
						+ "P BY padre ORDER BY padre) tabla1, financiera.rubro r\nWHERE r.codigo = tabla1.padre\n) subquery\nWHERE financiera.rubro.id"
						+ " = subquery.id;";
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tPostgresqlRow_6:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tPostgresqlRow_7Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tPostgresqlRow_7 = "UPDATE financiera.rubro\nSET unidad_ejecutora=subquery.ue\nFROM (\nSELECT r.id, tabla1.ue\nFROM (SELECT padre, POWER(mul(ta"
						+ "bla_1.unidad_ejecutora), 1.0/COUNT(*)) as ue FROM\n(SELECT financiera.rubro.*, (regexp_matches (codigo, '^(([0-9]*){1}(-["
						+ "0-9]*){1})'))[1] AS padre FROM financiera.rubro WHERE codigo ~ '^([0-9]*){1}(-[0-9]*){2}$' ORDER BY codigo) tabla_1 GROU"
						+ "P BY padre ORDER BY padre) tabla1, financiera.rubro r\nWHERE r.codigo = tabla1.padre\n) subquery\nWHERE financiera.rubro.id"
						+ " = subquery.id;";
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tPostgresqlRow_7:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tPostgresqlRow_8Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tPostgresqlRow_8 = "jdbc:postgresql://"
						+ "localhost" + ":" + "5432" + "/" + "test";

				String dbUser_tPostgresqlRow_8 = "test";

				final String decryptedPassword_tPostgresqlRow_8 = routines.system.PasswordEncryptUtil
						.decryptPassword("f3e656537b1a4d67");

				String dbPwd_tPostgresqlRow_8 = decryptedPassword_tPostgresqlRow_8;

				conn_tPostgresqlRow_8 = java.sql.DriverManager.getConnection(
						url_tPostgresqlRow_8, dbUser_tPostgresqlRow_8,
						dbPwd_tPostgresqlRow_8);
				...
				java.sql.Statement stmt_tPostgresqlRow_8 = conn_tPostgresqlRow_8
						.createStatement();
				...
				query_tPostgresqlRow_8 = "UPDATE financiera.rubro\nSET unidad_ejecutora=subquery.ue\nFROM (\nSELECT r.id, tabla1.ue\nFROM (SELECT padre, POWER(mul(ta"
						+ "bla_1.unidad_ejecutora), 1.0/COUNT(*)) as ue FROM\n(SELECT financiera.rubro.*, (regexp_matches (codigo, '^(([0-9]*){1}(-["
						+ "0-9]*){0})'))[1] AS padre FROM financiera.rubro WHERE codigo ~ '^([0-9]*){1}(-[0-9]*){1}$' ORDER BY codigo) tabla_1 GROU"
						+ "P BY padre ORDER BY padre) tabla1, financiera.rubro r\nWHERE r.codigo = tabla1.padre\n) subquery\nWHERE financiera.rubro.id"
						+ " = subquery.id;";
				...
				/**
				 * [tPostgresqlRow_8 process_data_begin ] start
				 */

				currentComponent = "tPostgresqlRow_8";

				/**
				 * [tPostgresqlRow_8 process_data_begin ] stop
				 */

				/**
				 * [tPostgresqlRow_8 process_data_end ] start
				 */

				currentComponent = "tPostgresqlRow_8";

				/**
				 * [tPostgresqlRow_8 process_data_end ] stop
				 */
	...
	public static void main(String[] args) {
		final ajuste_unidad_ejecutora ajuste_unidad_ejecutoraClass = new ajuste_unidad_ejecutora();

		int exitCode = ajuste_unidad_ejecutoraClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ajuste_unidad_ejecutora.class
					.getClassLoader().getResourceAsStream(
							"migraciones/ajuste_unidad_ejecutora_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = ajuste_unidad_ejecutora.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : ajuste_unidad_ejecutora");
		}
...
/************************************************************************************************
 * 69268 characters generated by Talend Open Studio for Data Integration on the
 * October 11, 2018 9:57:24 AM COT
 ************************************************************************************************/
