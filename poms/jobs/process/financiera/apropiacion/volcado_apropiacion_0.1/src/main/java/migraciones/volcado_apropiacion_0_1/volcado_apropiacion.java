...
package migraciones.volcado_apropiacion_0_1;
...
public class volcado_apropiacion implements TalendJob {
	...
	public static class row5Struct implements
		...
		final static byte[] commonByteArrayLock_MIGRACIONES_volcado_apropiacion = new byte[0];
		static byte[] commonByteArray_MIGRACIONES_volcado_apropiacion = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MIGRACIONES_volcado_apropiacion) {
	...
	public static class row1Struct implements
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MIGRACIONES_volcado_apropiacion.length) {
					if (length < 1024
							&& commonByteArray_MIGRACIONES_volcado_apropiacion.length == 0) {
						commonByteArray_MIGRACIONES_volcado_apropiacion = new byte[1024];
					} else {
						commonByteArray_MIGRACIONES_volcado_apropiacion = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MIGRACIONES_volcado_apropiacion,
						0, length);
				strReturn = new String(
						commonByteArray_MIGRACIONES_volcado_apropiacion, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tPostgresqlOutput_1 == null
					...
					tableName_tPostgresqlOutput_1 = "apropiacion";
				} else {
				...
				String insert_tPostgresqlOutput_1 = "INSERT INTO \""
						...
						+ "\" (\"vigencia\",\"valor\",\"rubro\",\"estado\") VALUES (?,?,?,?)";

				java.sql.PreparedStatement pstmt_tPostgresqlOutput_1 = conn_tPostgresqlOutput_1
						.prepareStatement(insert_tPostgresqlOutput_1);

				StringBuffer query_tPostgresqlOutput_1 = null;

				String[] insertSQLSplits_tPostgresqlOutput_1 = insert_tPostgresqlOutput_1
						.split("\\?");
				...
				String dbquery_tOracleInput_2 = "SELECT * FROM PR.PR_APROPIACION where vigencia > 2015";
					...
					while (rs_tOracleInput_2.next()) {
						...
						if (colQtyInRs_tOracleInput_2 < 1) {
							...
							if (rs_tOracleInput_2.getObject(1) != null) {
								row1.VIGENCIA = rs_tOracleInput_2
										.getBigDecimal(1);
							} else {
						...
						if (colQtyInRs_tOracleInput_2 < 2) {
							...
							if (rs_tOracleInput_2.getObject(2) != null) {
								row1.RUBRO_INTERNO = rs_tOracleInput_2
										.getBigDecimal(2);
							} else {
						...
						if (colQtyInRs_tOracleInput_2 < 3) {
							...
							row1.CODIGO_COMPANIA = routines.system.JDBCUtil
									.getString(rs_tOracleInput_2, 3, false);
						}
						...
						if (colQtyInRs_tOracleInput_2 < 5) {
							row1.VALOR_REZAGO = null;
						} else {

							if (rs_tOracleInput_2.getObject(5) != null) {
								row1.VALOR_REZAGO = rs_tOracleInput_2
										.getBigDecimal(5);
							} else {
						...
						if (colQtyInRs_tOracleInput_2 < 6) {
							row1.VALOR_MODIFICACIONES = null;
						} else {

							if (rs_tOracleInput_2.getObject(6) != null) {
								row1.VALOR_MODIFICACIONES = rs_tOracleInput_2
										.getBigDecimal(6);
							} else {
						...
						if (colQtyInRs_tOracleInput_2 < 7) {
							...
							if (rs_tOracleInput_2.getObject(7) != null) {
								row1.VALOR = rs_tOracleInput_2.getBigDecimal(7);
							} else {
						...
						if (colQtyInRs_tOracleInput_2 < 8) {
							...
							row1.TIPO_DOCUMENTO = routines.system.JDBCUtil
									.getString(rs_tOracleInput_2, 8, false);
						}
						if (colQtyInRs_tOracleInput_2 < 9) {
							...
							row1.DOCUMENTOS_NUMERO = routines.system.JDBCUtil
									.getString(rs_tOracleInput_2, 9, false);
						}
						if (colQtyInRs_tOracleInput_2 < 10) {
							row1.DOCUMENTOS_FECHA = null;
						} else {

							row1.DOCUMENTOS_FECHA = routines.system.JDBCUtil
									.getDate(rs_tOracleInput_2, 10);
						}
						if (colQtyInRs_tOracleInput_2 < 11) {
							...
							if (rs_tOracleInput_2.getObject(11) != null) {
								row1.ID_LIMAY_PL = rs_tOracleInput_2
										.getBigDecimal(11);
							} else {
						...
						if (colQtyInRs_tOracleInput_2 < 12) {
							...
							if (rs_tOracleInput_2.getObject(12) != null) {
								row1.ID_LIMAY = rs_tOracleInput_2
										.getBigDecimal(12);
							} else {
						...
						if (colQtyInRs_tOracleInput_2 < 13) {
							row1.ID_LIMAY_VF = null;
						} else {

							if (rs_tOracleInput_2.getObject(13) != null) {
								row1.ID_LIMAY_VF = rs_tOracleInput_2
										.getBigDecimal(13);
							} else {
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row2HashKey.INTERNO_RUBRO = row1.RUBRO_INTERNO;
						...
						if (tHash_Lookup_row2 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.INTERNO_RUBRO = '"
							// + row2HashKey.INTERNO_RUBRO + "'");
						} // G 071
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row6HashKey.codigo = row2.CODIGO;
						...
						if (tHash_Lookup_row6 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.codigo = '"
							// + row6HashKey.codigo + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							if (!rejectedInnerJoin_tMap_1) {
								...
								salida_postgres_tmp.vigencia = row1.VIGENCIA;
								salida_postgres_tmp.valor = row1.VALOR;
								salida_postgres_tmp.rubro = row6.id;
								salida_postgres_tmp.estado = 1;
						...
						if (salida_postgres != null) {
							...
							try {
								row3.vigencia = TypeConvert
										.BigDecimal2BigDecimal(salida_postgres.vigencia);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row3.valor = TypeConvert
										.BigDecimal2BigDecimal(salida_postgres.valor);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row3.rubro = TypeConvert
										.Integer2Integer(salida_postgres.rubro);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row3.estado = TypeConvert
										.Integer2Integer(salida_postgres.estado);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							...
							if (row3 != null) {
								...
								if (row3.vigencia != null) { //

									strBuffer_tLogRow_2
											.append(row3.vigencia
													.setScale(
															0,
								...
								query_tPostgresqlOutput_1 = new StringBuffer("");
								whetherReject_tPostgresqlOutput_1 = false;
								pstmt_tPostgresqlOutput_1.setBigDecimal(1,
										row5.vigencia);

								query_tPostgresqlOutput_1 = query_tPostgresqlOutput_1
										.append(insertSQLSplits_tPostgresqlOutput_1[0])
										.append(row5.vigencia == null ? "null"
												: String.valueOf(row5.vigencia))
										.append(insertSQLSplits_tPostgresqlOutput_1[1]);
								pstmt_tPostgresqlOutput_1.setBigDecimal(2,
										row5.valor);

								query_tPostgresqlOutput_1 = query_tPostgresqlOutput_1
										.append(row5.valor == null ? "null"
												: String.valueOf(row5.valor))
										.append(insertSQLSplits_tPostgresqlOutput_1[2]);
								if (row5.rubro == null) {
								...
								query_tPostgresqlOutput_1 = query_tPostgresqlOutput_1
										.append(row5.rubro == null ? "null"
												: String.valueOf(row5.rubro))
										.append(insertSQLSplits_tPostgresqlOutput_1[3]);
								if (row5.estado == null) {
								...
								query_tPostgresqlOutput_1 = query_tPostgresqlOutput_1
										.append(row5.estado == null ? "null"
												: String.valueOf(row5.estado))
										.append(insertSQLSplits_tPostgresqlOutput_1[4]);
								globalMap.put("tPostgresqlOutput_1_QUERY",
										query_tPostgresqlOutput_1.toString()
												.trim());
	...
	public void tOracleInput_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(row2) outputs:()
				// linked node: tMap_1 - inputs:(row1,row2,row6)
				...
				String dbquery_tOracleInput_1 = "SELECT ROWNUM \"id\", TAB1.* FROM \n(SELECT\nINTERNO_RUBRO,\n1 \"entidad\",\nCODIGO_NIVEL1||'-'||CODIGO_NIVEL2||'-'||CODIGO"
						+ "_NIVEL3||'-'||CODIGO_NIVEL4||'-'||CODIGO_NIVEL5||'-'|\n |CODIGO_NIVEL6||'-'||CODIGO_NIVEL7||'-'||CODIGO_NIVEL8 AS \"codig"
						+ "o\",\nVIGENCIA AS \"vigencia\",\nDESCRIPCION AS \"descripcion\",\n1 \"tipo_plan\",\n'1' \"administracion\",\n1 \"estado\"\nFRO"
						+ "M PR.PR_V_RUBROS) TAB1";
				...
				try {
					...
					while (rs_tOracleInput_1.next()) {
						...
						if (colQtyInRs_tOracleInput_1 < 2) {
							row2.INTERNO_RUBRO = null;
						} else {

							if (rs_tOracleInput_1.getObject(2) != null) {
								row2.INTERNO_RUBRO = rs_tOracleInput_1
										.getBigDecimal(2);
							} else {
						...
						if (colQtyInRs_tOracleInput_1 < 3) {
							...
							if (rs_tOracleInput_1.getObject(3) != null) {
								row2.entidad = rs_tOracleInput_1
										.getBigDecimal(3);
							} else {
						...
						if (colQtyInRs_tOracleInput_1 < 4) {
							...
							row2.CODIGO = routines.system.JDBCUtil.getString(
						...
						if (colQtyInRs_tOracleInput_1 < 5) {
							...
							if (rs_tOracleInput_1.getObject(5) != null) {
								row2.vigencia = rs_tOracleInput_1
										.getBigDecimal(5);
							} else {
						...
						if (colQtyInRs_tOracleInput_1 < 7) {
							...
							if (rs_tOracleInput_1.getObject(7) != null) {
								row2.tipo_plan = rs_tOracleInput_1
										.getBigDecimal(7);
							} else {
						...
						if (colQtyInRs_tOracleInput_1 < 8) {
							row2.administracion = null;
						} else {

							row2.administracion = routines.system.JDBCUtil
						...
						row2_HashRow.INTERNO_RUBRO = row2.INTERNO_RUBRO;

						row2_HashRow.entidad = row2.entidad;
						...
						row2_HashRow.tipo_plan = row2.tipo_plan;

						row2_HashRow.administracion = row2.administracion;
	...
	public void tPostgresqlInput_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(after_tOracleInput_2) outputs:(row6,row6) | target
				...
				String dbquery_tPostgresqlInput_1 = "SELECT * FROM financiera.rubro";
					...
					while (rs_tPostgresqlInput_1.next()) {
						...
						if (colQtyInRs_tPostgresqlInput_1 < 1) {
							...
							if (rs_tPostgresqlInput_1.getObject(1) != null) {
								row6.id = rs_tPostgresqlInput_1.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tPostgresqlInput_1 < 2) {
							...
							if (rs_tPostgresqlInput_1.getObject(2) != null) {
								row6.entidad = rs_tPostgresqlInput_1
										.getShort(2);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tPostgresqlInput_1 < 3) {
							...
							row6.codigo = routines.system.JDBCUtil.getString(
						...
						if (colQtyInRs_tPostgresqlInput_1 < 5) {
							row6.unidad_ejecutora = null;
						} else {

							if (rs_tPostgresqlInput_1.getObject(5) != null) {
								row6.unidad_ejecutora = rs_tPostgresqlInput_1
										.getShort(5);
							} else {
								row6.unidad_ejecutora = null;
							}
						...
						if (colQtyInRs_tPostgresqlInput_1 < 6) {
							row6.descripcion = null;
						} else {

							row6.descripcion = routines.system.JDBCUtil
						...
						row6_HashRow.entidad = row6.entidad;

						row6_HashRow.codigo = row6.codigo;

						row6_HashRow.nombre = row6.nombre;

						row6_HashRow.unidad_ejecutora = row6.unidad_ejecutora;

						row6_HashRow.descripcion = row6.descripcion;
		...
		try {
			...
			java.io.InputStream inContext = volcado_apropiacion.class
					.getClassLoader().getResourceAsStream(
							"migraciones/volcado_apropiacion_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = volcado_apropiacion.class
						.getClassLoader()
						.getResourceAsStream(
...
/************************************************************************************************
 * 120550 characters generated by Talend Open Studio for Data Integration on the
 * October 10, 2018 11:22:45 AM COT
 ************************************************************************************************/
