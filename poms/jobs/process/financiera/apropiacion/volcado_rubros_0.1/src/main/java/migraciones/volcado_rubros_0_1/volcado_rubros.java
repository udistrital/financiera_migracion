...
package migraciones.volcado_rubros_0_1;
...
/**
 * Job: volcado_rubros Purpose: Volcar los rubros desde SiCapital hacia el ERP<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class volcado_rubros implements TalendJob {
	...
	private final String jobName = "volcado_rubros";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					volcado_rubros.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(volcado_rubros.this, new Object[] { e,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_MIGRACIONES_volcado_rubros = new byte[0];
		static byte[] commonByteArray_MIGRACIONES_volcado_rubros = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MIGRACIONES_volcado_rubros.length) {
					if (length < 1024
							&& commonByteArray_MIGRACIONES_volcado_rubros.length == 0) {
						commonByteArray_MIGRACIONES_volcado_rubros = new byte[1024];
					} else {
						commonByteArray_MIGRACIONES_volcado_rubros = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MIGRACIONES_volcado_rubros, 0,
						length);
				strReturn = new String(
						commonByteArray_MIGRACIONES_volcado_rubros, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MIGRACIONES_volcado_rubros) {

				try {

					int length = 0;

					this.entidad = dis.readInt();
	...
	public static class row1Struct implements
		...
		public Integer tipo_plan;

		public Integer getTipo_plan() {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MIGRACIONES_volcado_rubros) {
				...
				try {
					...
					this.tipo_plan = readInteger(dis);

					this.administracion = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.tipo_plan, dos);

				// String

				writeString(this.administracion, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String insert_tPostgresqlOutput_1 = "INSERT INTO \""
						...
						+ "\" (\"entidad\",\"codigo\",\"nombre\",\"unidad_ejecutora\") VALUES (?,?,?,?)";
				...
				String dbquery_tOracleInput_1 = "SELECT MAX(TAB1.INTERNO_RUBRO), MAX(TAB1.\"entidad\"), TAB1.\"codigo\", MAX(TAB1.\"vigencia\"), MAX(TAB1.\"descripcion"
						...
						+ "O_NIVEL6||'-'||CODIGO_NIVEL7||'-'||CODIGO_NIVEL8 AS \"codigo\",\n	VIGENCIA AS \"vigencia\",\n	DESCRIPCION AS \"descripcion"
						+ "\",\n	1 \"tipo_plan\",\n	'1' \"administracion\",\n	1 \"estado\"\n	FROM PR.PR_V_RUBROS WHERE vigencia > 2015) TAB1\nGROUP BY T"
						+ "AB1.\"codigo\"\n\nUNION\n\nSELECT 0 AS \"INTERNO_RUBRO\", 1 AS \"entidad\", \"codigo\", 1 AS \"vigencia\", \"descripcion\", "
						+ "1 AS \"tipo_plan\", '1' AS \"administracion\", 1 AS \"estado\" FROM \n(\n	SELECT\n		pr_nivel1.codigo || '-' ||\n		pr_nivel2."
						+ "codigo || '-' ||\n		pr_nivel3.codigo || '-' ||\n		pr_nivel4.codigo || '-' ||\n		pr_nivel5.codigo || '-' ||\n		pr_nivel6.codi"
						+ "go || '-' ||\n		pr_nivel7.codigo as \"codigo\",\n		MAX(pr_nivel7.DESCRIPCION) AS \"descripcion\"\n		FROM\n			pr_nivel7,\n			p"
						+ "r_nivel6,\n			pr_nivel5,\n			pr_nivel4,\n			pr_nivel3,\n			pr_nivel2,\n			pr_nivel1\n		WHERE\n			pr_nivel7.vigencia = pr_nivel6"
						+ ".vigencia AND\n			pr_nivel7.interno_nivel6 = pr_nivel6.INTERNO AND\n			pr_nivel7.tipo_plan = pr_nivel6.tipo_plan AND\n			pr"
						+ "_nivel6.vigencia = pr_nivel5.vigencia AND\n			pr_nivel6.interno_nivel5 = pr_nivel5.INTERNO AND\n			pr_nivel6.tipo_plan = p"
						+ "r_nivel5.tipo_plan AND\n			pr_nivel5.vigencia = pr_nivel4.vigencia AND\n			pr_nivel5.interno_nivel4 = pr_nivel4.INTERNO AN"
						+ "D\n			pr_nivel5.tipo_plan = pr_nivel4.tipo_plan AND\n			pr_nivel4.vigencia = pr_nivel3.vigencia AND\n			pr_nivel4.interno_n"
						+ "ivel3 = pr_nivel3.INTERNO AND\n			pr_nivel4.tipo_plan = pr_nivel3.tipo_plan AND\n			pr_nivel3.vigencia = pr_nivel2.vigenci"
						+ "a AND\n			pr_nivel3.interno_nivel2 = pr_nivel2.INTERNO AND\n			pr_nivel3.tipo_plan = pr_nivel2.tipo_plan AND\n			pr_nivel2."
						+ "vigencia = pr_nivel1.vigencia AND\n			pr_nivel2.interno_nivel1 = pr_nivel1.INTERNO AND\n			pr_nivel2.tipo_plan = pr_nivel1"
						+ ".tipo_plan AND\n			pr_nivel7.vigencia > 2015 AND\n			pr_nivel7.descripcion NOT LIKE 'NO APLICA'\n		GROUP BY pr_nivel1.codig"
						+ "o || '-' || pr_nivel2.codigo || '-' || pr_nivel3.codigo || '-' || pr_nivel4.codigo || '-' || pr_nivel5.codigo || '-' || "
						+ "pr_nivel6.codigo || '-' || pr_nivel7.codigo\n\n	UNION\n\n	SELECT\n		pr_nivel1.codigo || '-' ||\n		pr_nivel2.codigo || '-' ||\n	"
						+ "	pr_nivel3.codigo || '-' ||\n		pr_nivel4.codigo || '-' ||\n		pr_nivel5.codigo || '-' ||\n		pr_nivel6.codigo as \"codigo\",\n"
						+ "		MAX(pr_nivel6.DESCRIPCION) AS \"descripcion\"\n		FROM\n			pr_nivel6,\n			pr_nivel5,\n			pr_nivel4,\n			pr_nivel3,\n			pr_niv"
						+ "el2,\n			pr_nivel1\n		WHERE\n			pr_nivel6.vigencia = pr_nivel5.vigencia AND\n			pr_nivel6.interno_nivel5 = pr_nivel5.INTERNO"
						+ " AND\n			pr_nivel6.tipo_plan = pr_nivel5.tipo_plan AND\n			pr_nivel5.vigencia = pr_nivel4.vigencia AND\n			pr_nivel5.intern"
						+ "o_nivel4 = pr_nivel4.INTERNO AND\n			pr_nivel5.tipo_plan = pr_nivel4.tipo_plan AND\n			pr_nivel4.vigencia = pr_nivel3.vige"
						+ "ncia AND\n			pr_nivel4.interno_nivel3 = pr_nivel3.INTERNO AND\n			pr_nivel4.tipo_plan = pr_nivel3.tipo_plan AND\n			pr_nive"
						+ "l3.vigencia = pr_nivel2.vigencia AND\n			pr_nivel3.interno_nivel2 = pr_nivel2.INTERNO AND\n			pr_nivel3.tipo_plan = pr_niv"
						+ "el2.tipo_plan AND\n			pr_nivel2.vigencia = pr_nivel1.vigencia AND\n			pr_nivel2.interno_nivel1 = pr_nivel1.INTERNO AND\n			"
						+ "pr_nivel2.tipo_plan = pr_nivel1.tipo_plan \n			AND pr_nivel6.vigencia > 2015 AND\n			pr_nivel6.descripcion NOT LIKE 'NO AP"
						+ "LICA'\n		GROUP BY pr_nivel1.codigo || '-' || pr_nivel2.codigo || '-' || pr_nivel3.codigo || '-' || pr_nivel4.codigo || '-"
						+ "' || pr_nivel5.codigo || '-' || pr_nivel6.codigo\n\n		UNION\n\n		SELECT\n			pr_nivel1.codigo || '-' ||\n			pr_nivel2.codigo ||"
						+ " '-' ||\n			pr_nivel3.codigo || '-' ||\n			pr_nivel4.codigo || '-' ||\n			pr_nivel5.codigo as \"codigo\",\n			MAX(pr_nivel5."
						+ "DESCRIPCION) AS \"descripcion\"\n			FROM\n			pr_nivel5,\n			pr_nivel4,\n			pr_nivel3,\n			pr_nivel2,\n			pr_nivel1\n			WHERE\n		"
						+ "	pr_nivel5.vigencia = pr_nivel4.vigencia AND\n			pr_nivel5.interno_nivel4 = pr_nivel4.INTERNO AND\n			pr_nivel5.tipo_plan "
						+ "= pr_nivel4.tipo_plan AND\n			pr_nivel4.vigencia = pr_nivel3.vigencia AND\n			pr_nivel4.interno_nivel3 = pr_nivel3.INTERNO"
						+ " AND\n			pr_nivel4.tipo_plan = pr_nivel3.tipo_plan AND\n			pr_nivel3.vigencia = pr_nivel2.vigencia AND\n			pr_nivel3.intern"
						+ "o_nivel2 = pr_nivel2.INTERNO AND\n			pr_nivel3.tipo_plan = pr_nivel2.tipo_plan AND\n			pr_nivel2.vigencia = pr_nivel1.vige"
						+ "ncia AND\n			pr_nivel2.interno_nivel1 = pr_nivel1.INTERNO AND\n			pr_nivel2.tipo_plan = pr_nivel1.tipo_plan\n			AND pr_nive"
						+ "l5.vigencia > 2015 AND\n			pr_nivel5.descripcion NOT LIKE 'NO APLICA'\n			GROUP BY pr_nivel1.codigo || '-' || pr_nivel2.co"
						+ "digo || '-' || pr_nivel3.codigo || '-' || pr_nivel4.codigo || '-' || pr_nivel5.codigo\n\n	UNION\n\n		SELECT\n			pr_nivel1.cod"
						+ "igo || '-' ||\n			pr_nivel2.codigo || '-' ||\n			pr_nivel3.codigo || '-' ||\n			pr_nivel4.codigo as \"codigo\",\n			MAX(pr_n"
						+ "ivel4.DESCRIPCION) AS \"descripcion\"\n		FROM\n			pr_nivel4,\n			pr_nivel3,\n			pr_nivel2,\n			pr_nivel1\n		WHERE\n			pr_nivel4"
						+ ".vigencia = pr_nivel3.vigencia AND\n			pr_nivel4.interno_nivel3 = pr_nivel3.INTERNO AND\n			pr_nivel4.tipo_plan = pr_nivel"
						+ "3.tipo_plan AND\n			pr_nivel3.vigencia = pr_nivel2.vigencia AND\n			pr_nivel3.interno_nivel2 = pr_nivel2.INTERNO AND\n			pr"
						+ "_nivel3.tipo_plan = pr_nivel2.tipo_plan AND\n			pr_nivel2.vigencia = pr_nivel1.vigencia AND\n			pr_nivel2.interno_nivel1 ="
						+ " pr_nivel1.INTERNO AND\n			pr_nivel2.tipo_plan = pr_nivel1.tipo_plan\n			AND pr_nivel4.vigencia > 2015 AND\n			pr_nivel4.de"
						+ "scripcion NOT LIKE 'NO APLICA'\n		GROUP BY pr_nivel1.codigo || '-' || pr_nivel2.codigo || '-' || pr_nivel3.codigo || '-' "
						+ "|| pr_nivel4.codigo\n\n	UNION	\n\n	SELECT\n		pr_nivel1.codigo || '-' ||\n		pr_nivel2.codigo || '-' ||\n		pr_nivel3.codigo as \""
						+ "codigo\",\n		MAX(pr_nivel3.DESCRIPCION) AS \"descripcion\"\n	FROM\n		pr_nivel3,\n		pr_nivel2,\n		pr_nivel1\n	WHERE\n		pr_nivel3"
						+ ".vigencia = pr_nivel2.vigencia AND\n		pr_nivel3.interno_nivel2 = pr_nivel2.INTERNO AND\n		pr_nivel3.tipo_plan = pr_nivel2."
						+ "tipo_plan AND\n		pr_nivel2.vigencia = pr_nivel1.vigencia AND\n		pr_nivel2.interno_nivel1 = pr_nivel1.INTERNO AND\n		pr_nive"
						+ "l2.tipo_plan = pr_nivel1.tipo_plan\n		AND pr_nivel3.vigencia > 2015 AND\n		pr_nivel3.descripcion NOT LIKE 'NO APLICA'\n	GRO"
						+ "UP BY pr_nivel1.codigo || '-' || pr_nivel2.codigo || '-' || pr_nivel3.codigo\n\n	UNION\n\n	SELECT\n		pr_nivel1.codigo || '-' "
						+ "||\n		pr_nivel2.codigo as \"codigo\",\n		MAX(pr_nivel2.DESCRIPCION) AS \"descripcion\"\n	FROM\n		pr_nivel2,\n		pr_nivel1\n	WHE"
						+ "RE\n		pr_nivel2.vigencia = pr_nivel1.vigencia AND\n		pr_nivel2.interno_nivel1 = pr_nivel1.INTERNO AND\n		pr_nivel2.tipo_pla"
						+ "n = pr_nivel1.tipo_plan\n		AND pr_nivel2.vigencia > 2015 AND\n		pr_nivel2.descripcion NOT LIKE 'NO APLICA'\n	GROUP BY pr_ni"
						+ "vel1.codigo || '-' || pr_nivel2.codigo\n\n	UNION\n\n	SELECT\n		pr_nivel1.codigo as \"codigo\",\n		MAX(pr_nivel1.DESCRIPCION) A"
						+ "S \"descripcion\"\n	FROM\n		pr_nivel1\n	WHERE\n		pr_nivel1.vigencia > 2015 AND\n		pr_nivel1.descripcion NOT LIKE 'NO APLICA'\n"
					...
					while (rs_tOracleInput_1.next()) {
						...
						if (colQtyInRs_tOracleInput_1 < 2) {
							...
							if (rs_tOracleInput_1.getObject(2) != null) {
								row1.entidad = rs_tOracleInput_1.getInt(2);
							} else {
						...
						if (colQtyInRs_tOracleInput_1 < 3) {
							...
							row1.codigo = routines.system.JDBCUtil.getString(
						...
						if (colQtyInRs_tOracleInput_1 < 4) {
							...
							if (rs_tOracleInput_1.getObject(4) != null) {
								row1.vigencia = rs_tOracleInput_1.getInt(4);
							} else {
						...
						if (colQtyInRs_tOracleInput_1 < 6) {
							...
							if (rs_tOracleInput_1.getObject(6) != null) {
								row1.tipo_plan = rs_tOracleInput_1.getInt(6);
							} else {
						...
						if (colQtyInRs_tOracleInput_1 < 7) {
							...
							row1.administracion = routines.system.JDBCUtil
						...
						if (colQtyInRs_tOracleInput_1 < 8) {
							...
							if (rs_tOracleInput_1.getObject(8) != null) {
								row1.estado = rs_tOracleInput_1.getInt(8);
							} else {
						...
						if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
							...
							row2HashKey.RUBRO_INTERNO = row1.INTERNO_RUBRO;
						...
						{ // start of Var scope
							...
							if (!rejectedInnerJoin_tMap_3) {
								...
								salida_postgres_tmp.entidad = row1.entidad;
								salida_postgres_tmp.codigo = row1.codigo;
								salida_postgres_tmp.nombre = row1.descripcion;
								salida_postgres_tmp.unidad_ejecutora = Integer
										.parseInt(row2.CODIGO_UNIDAD_EJECUTORA);
						...
						if (salida_postgres != null) {
							...
							try {
								row4.entidad = TypeConvert
										.int2int(salida_postgres.entidad);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row4.codigo = TypeConvert
										.String2String(salida_postgres.codigo);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row4.nombre = TypeConvert
										.String2String(salida_postgres.nombre);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row4.unidad_ejecutora = TypeConvert
										.int2int(salida_postgres.unidad_ejecutora);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
				...
				if (resourceMap.get("finish_tPostgresqlOutput_1") == null) {
					if (resourceMap.get("conn_tPostgresqlOutput_1") != null) {
						try {
							...
							java.sql.Connection ctn_tPostgresqlOutput_1 = (java.sql.Connection) resourceMap
									.get("conn_tPostgresqlOutput_1");
	...
	public static class row2Struct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.RUBRO_INTERNO == null) ? 0
								: this.RUBRO_INTERNO.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.RUBRO_INTERNO == null) {
				if (other.RUBRO_INTERNO != null)
					return false;

			} else if (!this.RUBRO_INTERNO.equals(other.RUBRO_INTERNO))
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.CODIGO_UNIDAD_EJECUTORA = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.CODIGO_UNIDAD_EJECUTORA, dos, oos);
		...
		public int compareTo(row2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.RUBRO_INTERNO,
					other.RUBRO_INTERNO);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tOracleInput_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tOracleInput_2 = "SELECT RUBRO_INTERNO, CODIGO_UNIDAD_EJECUTORA FROM PR.PR_APROPIACION WHERE vigencia > 2015 GROUP BY RUBRO_INTERNO, CODI"
						+ "GO_UNIDAD_EJECUTORA ORDER BY RUBRO_INTERNO";
				...
				try {
					...
					while (rs_tOracleInput_2.next()) {
						...
						if (colQtyInRs_tOracleInput_2 < 2) {
							...
							row2.CODIGO_UNIDAD_EJECUTORA = routines.system.JDBCUtil
						...
						row2_HashRow.RUBRO_INTERNO = row2.RUBRO_INTERNO;

						row2_HashRow.CODIGO_UNIDAD_EJECUTORA = row2.CODIGO_UNIDAD_EJECUTORA;
	...
	public static void main(String[] args) {
		final volcado_rubros volcado_rubrosClass = new volcado_rubros();

		int exitCode = volcado_rubrosClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = volcado_rubros.class
					.getClassLoader().getResourceAsStream(
							"migraciones/volcado_rubros_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = volcado_rubros.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : volcado_rubros");
		}
...
/************************************************************************************************
 * 100404 characters generated by Talend Open Studio for Data Integration on the
 * October 11, 2018 10:54:39 AM COT
 ************************************************************************************************/
