...
package migraciones.volcado_cdp_0_1;
...
public static class salida_disponibilidad_apropiacionStruct implements routines.system.IPersistableRow<salida_disponibilidad_apropiacionStruct> {
    final static byte[] commonByteArrayLock_MIGRACIONES_volcado_cdp = new byte[0];
    static byte[] commonByteArray_MIGRACIONES_volcado_cdp = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MIGRACIONES_volcado_cdp) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MIGRACIONES_volcado_cdp.length) {
				if(length < 1024 && commonByteArray_MIGRACIONES_volcado_cdp.length == 0) {
   					commonByteArray_MIGRACIONES_volcado_cdp = new byte[1024];
				} else {
   					commonByteArray_MIGRACIONES_volcado_cdp = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MIGRACIONES_volcado_cdp, 0, length);
			strReturn = new String(commonByteArray_MIGRACIONES_volcado_cdp, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
String dbUser_tPostgresqlOutput_3 = null;
    ...
    String url_tPostgresqlOutput_3 = "jdbc:postgresql://"+"172.30.3.207"+":"+"5432"+"/"+"udistrital_core_db";
    dbUser_tPostgresqlOutput_3 = "migracioncdp_job";
 
	final String decryptedPassword_tPostgresqlOutput_3 = routines.system.PasswordEncryptUtil.decryptPassword("01e7c2e641ee9e08a084bbcbee8da4efc3280c7e6e91305d39a3db4fda29545af4f7aba1746784ea");
...
String dbUser_tPostgresqlOutput_1 = null;
    ...
    java.lang.Class.forName("org.postgresql.Driver");
    String url_tPostgresqlOutput_1 = "jdbc:postgresql://"+"172.30.3.207"+":"+"5432"+"/"+"udistrital_core_db";
    dbUser_tPostgresqlOutput_1 = "migracioncdp_job";
 
	final String decryptedPassword_tPostgresqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("01e7c2e641ee9e08a084bbcbee8da4efc3280c7e6e91305d39a3db4fda29545af4f7aba1746784ea");
...
String dbUser_tPostgresqlOutput_2 = null;
    ...
    java.lang.Class.forName("org.postgresql.Driver");
    String url_tPostgresqlOutput_2 = "jdbc:postgresql://"+"172.30.3.207"+":"+"5432"+"/"+"udistrital_core_db";
    dbUser_tPostgresqlOutput_2 = "migracioncdp_job";
 
	final String decryptedPassword_tPostgresqlOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("01e7c2e641ee9e08a084bbcbee8da4efc3280c7e6e91305d39a3db4fda29545af4f7aba1746784ea");
        ...
        new BytesLimit65535_tPostgresqlInput_3().limitLog4jByte();
		    ...
		    java.sql.Connection conn_tPostgresqlInput_3 = null;
			    ...
			    java.lang.Class.forName(driverClass_tPostgresqlInput_3);
			   	String dbUser_tPostgresqlInput_3 = "migracioncdp_job";
			   	
        		
        		
        		 
	final String decryptedPassword_tPostgresqlInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("01e7c2e641ee9e08a084bbcbee8da4efc3280c7e6e91305d39a3db4fda29545af4f7aba1746784ea");
			   	
		        String dbPwd_tPostgresqlInput_3 = decryptedPassword_tPostgresqlInput_3;
		        
				
			String url_tPostgresqlInput_3 = "jdbc:postgresql://" + "172.30.3.207" + ":" + "5432" + "/" + "udistrital_core_db";
        ...
        new BytesLimit65535_tPostgresqlInput_1().limitLog4jByte();
		    ...
		    java.sql.Connection conn_tPostgresqlInput_1 = null;
			    ...
			    java.lang.Class.forName(driverClass_tPostgresqlInput_1);
			   	String dbUser_tPostgresqlInput_1 = "migracioncdp_job";
			   	
        		
        		
        		 
	final String decryptedPassword_tPostgresqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("01e7c2e641ee9e08a084bbcbee8da4efc3280c7e6e91305d39a3db4fda29545af4f7aba1746784ea");
			   	
		        String dbPwd_tPostgresqlInput_1 = decryptedPassword_tPostgresqlInput_1;
		        
				
			String url_tPostgresqlInput_1 = "jdbc:postgresql://" + "172.30.3.207" + ":" + "5432" + "/" + "udistrital_core_db";
        ...
        new BytesLimit65535_tDBInput_1().limitLog4jByte();
		    ...
		    java.sql.Connection conn_tDBInput_1 = null;
			    ...
			    java.lang.Class.forName(driverClass_tDBInput_1);
			   	String dbUser_tDBInput_1 = "migracioncdp_job";
			   	
        		
        		
        		 
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("01e7c2e641ee9e08a084bbcbee8da4efc3280c7e6e91305d39a3db4fda29545af4f7aba1746784ea");
			   	
		        String dbPwd_tDBInput_1 = decryptedPassword_tDBInput_1;
		        
				
			String url_tDBInput_1 = "jdbc:postgresql://" + "172.30.3.207" + ":" + "5432" + "/" + "udistrital_core_db";
		    ...
		    String dbquery_tDBInput_1 = "select (COALESCE(id,0)+1) as id from financiera.disponibilidad order by id desc limit 1";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = volcado_cdp.class.getClassLoader().getResourceAsStream("migraciones/volcado_cdp_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     309043 characters generated by Talend Open Studio for Data Integration 
 *     on the August 8, 2018 1:06:33 PM COT
 ************************************************************************************************/