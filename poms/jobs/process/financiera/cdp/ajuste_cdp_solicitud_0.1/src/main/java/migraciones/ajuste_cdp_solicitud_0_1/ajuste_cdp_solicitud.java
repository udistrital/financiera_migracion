...
package migraciones.ajuste_cdp_solicitud_0_1;
...
public static class salida_financiera_disponibilidad_proceso_externoStruct implements routines.system.IPersistableRow<salida_financiera_disponibilidad_proceso_externoStruct> {
    final static byte[] commonByteArrayLock_MIGRACIONES_ajuste_cdp_solicitud = new byte[0];
    static byte[] commonByteArray_MIGRACIONES_ajuste_cdp_solicitud = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MIGRACIONES_ajuste_cdp_solicitud) {
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MIGRACIONES_ajuste_cdp_solicitud.length) {
				if(length < 1024 && commonByteArray_MIGRACIONES_ajuste_cdp_solicitud.length == 0) {
   					commonByteArray_MIGRACIONES_ajuste_cdp_solicitud = new byte[1024];
				} else {
   					commonByteArray_MIGRACIONES_ajuste_cdp_solicitud = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MIGRACIONES_ajuste_cdp_solicitud, 0, length);
			strReturn = new String(commonByteArray_MIGRACIONES_ajuste_cdp_solicitud, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	final String decryptedPassword_tPostgresqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("01e7c2e641ee9e08a084bbcbee8da4efc3280c7e6e91305d39a3db4fda29545af4f7aba1746784ea");
		    ...
		    String dbquery_tPostgresqlInput_1 = "select* from administrativa.necesidad where id = (select (COALESCE(id,0)) as id from financiera.disponibilidad order by"
+" id desc limit 1)";
        ...
        new BytesLimit65535_tPostgresqlInput_2().limitLog4jByte();
		    ...
		    java.sql.Connection conn_tPostgresqlInput_2 = null;
			    ...
			    java.lang.Class.forName(driverClass_tPostgresqlInput_2);
			   	String dbUser_tPostgresqlInput_2 = "migracioncdp_job";
			   	
        		
        		
        		 
	final String decryptedPassword_tPostgresqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("01e7c2e641ee9e08a084bbcbee8da4efc3280c7e6e91305d39a3db4fda29545af4f7aba1746784ea");
			   	
		        String dbPwd_tPostgresqlInput_2 = decryptedPassword_tPostgresqlInput_2;
		        
				
			String url_tPostgresqlInput_2 = "jdbc:postgresql://" + "172.30.3.207" + ":" + "5432" + "/" + "udistrital_core_db";
		    ...
		    String dbquery_tPostgresqlInput_2 = "select * from financiera.disponibilidad where id = (select (COALESCE(id,0)) as id from financiera.disponibilidad order "
+"by id desc limit 1)";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ajuste_cdp_solicitud.class.getClassLoader().getResourceAsStream("migraciones/ajuste_cdp_solicitud_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     134776 characters generated by Talend Open Studio for Data Integration 
 *     on the August 8, 2018 1:06:34 PM COT
 ************************************************************************************************/