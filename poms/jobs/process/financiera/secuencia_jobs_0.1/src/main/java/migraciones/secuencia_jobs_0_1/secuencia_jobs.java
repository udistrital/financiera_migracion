...
package migraciones.secuencia_jobs_0_1;
...
public class secuencia_jobs implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(secuencia_jobs.this, new Object[] { e,
	...
	public static class row5Struct implements
		...
		final static byte[] commonByteArrayLock_MIGRACIONES_secuencia_jobs = new byte[0];
		static byte[] commonByteArray_MIGRACIONES_secuencia_jobs = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_MIGRACIONES_secuencia_jobs) {
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_5.put("disponibilidad",
						context.disponibilidad);
				paraList_tRunJob_5.add("--context_type " + "disponibilidad"
						+ "=" + "id_Integer");

				parentContextMap_tRunJob_5.put("vigencia", context.vigencia);
				paraList_tRunJob_5.add("--context_type " + "vigencia" + "="
						+ "id_Integer");

				parentContextMap_tRunJob_5.put("curr_id", context.curr_id);
				paraList_tRunJob_5.add("--context_type " + "curr_id" + "="
						+ "id_Integer");
				...
				migraciones.volcado_cdp_0_1.volcado_cdp childJob_tRunJob_5 = new migraciones.volcado_cdp_0_1.volcado_cdp();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_8.put("disponibilidad",
						context.disponibilidad);
				paraList_tRunJob_8.add("--context_type " + "disponibilidad"
						+ "=" + "id_Integer");

				parentContextMap_tRunJob_8.put("vigencia", context.vigencia);
				paraList_tRunJob_8.add("--context_type " + "vigencia" + "="
						+ "id_Integer");

				parentContextMap_tRunJob_8.put("curr_id", context.curr_id);
				paraList_tRunJob_8.add("--context_type " + "curr_id" + "="
						+ "id_Integer");
				...
				while (propertyNames_tRunJob_8.hasMoreElements()) {
					...
					if (value_tRunJob_8 != null) {
						paraList_tRunJob_8.add("--context_param "
								+ key_tRunJob_8 + "=" + value_tRunJob_8);
					} else {
						paraList_tRunJob_8
								.add("--context_param "
										+ key_tRunJob_8
				...
				migraciones.ajuste_cdp_solicitud_0_1.ajuste_cdp_solicitud childJob_tRunJob_8 = new migraciones.ajuste_cdp_solicitud_0_1.ajuste_cdp_solicitud();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = secuencia_jobs.class
					.getClassLoader().getResourceAsStream(
							"migraciones/secuencia_jobs_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = secuencia_jobs.class
						.getClassLoader()
						.getResourceAsStream(
			...
			try {
				context.disponibilidad = routines.system.ParserUtils
						.parseTo_Integer(context.getProperty("disponibilidad"));
			...
			try {
				context.vigencia = routines.system.ParserUtils
						.parseTo_Integer(context.getProperty("vigencia"));
			} catch (NumberFormatException e) {
			...
			try {
				context.curr_id = routines.system.ParserUtils
						.parseTo_Integer(context.getProperty("curr_id"));
			} catch (NumberFormatException e) {
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("disponibilidad")) {
				context.disponibilidad = (Integer) parentContextMap
						.get("disponibilidad");
			}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : secuencia_jobs");
		}
...
/************************************************************************************************
 * 47278 characters generated by Talend Open Studio for Data Integration on the
 * August 8, 2018 10:23:41 AM COT
 ************************************************************************************************/
